...
using TechagroApiSync.Agroland.DTOs;
using TechagroApiSync.Agroland.Helpers;
using TechagroApiSync.Shared.DTOs;
using TechagroApiSync.Shared.Helpers;
using TechagroApiSync.Shared.Repositories;

namespace TechagroApiSync.Agroland.Services
{
                        ...
                        try
                        {
                            ...
                            if (apiProduct.Photos != null)
                            {
                                foreach (var img in apiProduct.Photos)
                                {
                                    ...
                                    await _productRepo.UpsertProductImageAsync(apiProduct.Ean, apiProduct.Id.ToString() ?? "image", imageData);
